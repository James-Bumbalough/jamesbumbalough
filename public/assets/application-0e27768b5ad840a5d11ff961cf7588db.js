...
function PxLoader(t){t=t||{},null==t.statusInterval&&(t.statusInterval=5e3),null==t.loggingDelay&&(t.loggingDelay=2e4),null==t.noProgressTimeout&&(t.noProgressTimeout=1/0);var r,e=[],a=[],s=+new Date,n={QUEUED:0,WAITING:1,LOADED:2,ERROR:3,TIMEOUT:4},o=function(t){return null==t?[]:Array.isArray(t)?t:[t]};this.add=function(t){t.tags=new PxLoaderTags(t.tags),null==t.priority&&(t.priority=1/0),e.push({resource:t,status:n.QUEUED})},this.addProgressListener=function(t,r){a.push({callback:t,tags:new PxLoaderTags(r)})},this.addCompletionListener=function(t,r){a.push({tags:new PxLoaderTags(r),callback:function(r){r.completedCount===r.totalCount&&t()}})};var i=function(t){t=o(t);var r=function(r){for(var e=r.resource,a=1/0,s=0;s<e.tags.length;s++)for(var n=0;n<Math.min(t.length,a)&&!(e.tags[s]==t[n]&&a>n&&(a=n,0===a))&&0!==a;n++);return a};return function(t,e){var a=r(t),s=r(e);return s>a?-1:a>s?1:t.priority<e.priority?-1:t.priority>e.priority?1:0}};this.start=function(t){r=+new Date;var a=i(t);e.sort(a);for(var s=0,o=e.length;o>s;s++){var l=e[s];l.status=n.WAITING,l.resource.start(this)}setTimeout(u,100)};var u=function(){for(var r=!1,a=+new Date-s,o=a>=t.noProgressTimeout,i=a>=t.loggingDelay,l=0,c=e.length;c>l;l++){var g=e[l];g.status===n.WAITING&&(g.resource.checkStatus&&g.resource.checkStatus(),g.status===n.WAITING&&(o?g.resource.onTimeout():r=!0))}i&&r&&h(),r&&setTimeout(u,t.statusInterval)};this.isBusy=function(){for(var t=0,r=e.length;r>t;t++)if(e[t].status===n.QUEUED||e[t].status===n.WAITING)return!0;return!1};var l=function(t,r){for(var o=null,i=0,u=e.length;u>i;i++)if(e[i].resource===t){o=e[i];break}if(null!=o&&o.status===n.WAITING){o.status=r,s=+new Date;for(var i=(t.tags.length,0),l=a.length;l>i;i++){var h,g=a[i];h=0===g.tags.length?!0:t.tags.contains(g.tags),h&&c(o,g)}}};this.onLoad=function(t){l(t,n.LOADED)},this.onError=function(t){l(t,n.ERROR)},this.onTimeout=function(t){l(t,n.TIMEOUT)};var c=function(t,r){for(var a=0,s=0,o=0,i=e.length;i>o;o++){var u=e[o],l=!1;l=0===r.tags.length?!0:u.resource.tags.contains(r.tags),l&&(s++,(u.status===n.LOADED||u.status===n.ERROR||u.status===n.TIMEOUT)&&a++)}r.callback({resource:t.resource,loaded:t.status===n.LOADED,error:t.status===n.ERROR,timeout:t.status===n.TIMEOUT,completedCount:a,totalCount:s})},h=this.log=function(t){if(window.console){var a=Math.round((+new Date-r)/1e3);window.console.log("PxLoader elapsed: "+a+" sec");for(var s=0,o=e.length;o>s;s++){var i=e[s];if(t||i.status===n.WAITING){var u="PxLoader: #"+s+" "+i.resource.getName();switch(i.status){case n.QUEUED:u+=" (Not Started)";break;case n.WAITING:u+=" (Waiting)";break;case n.LOADED:u+=" (Loaded)";break;case n.ERROR:u+=" (Error)";break;case n.TIMEOUT:u+=" (Timeout)"}i.resource.tags.length>0&&(u+=" Tags: ["+i.resource.tags.join(",")+"]"),window.console.log(u)}}}}}function PxLoaderTags(t){if(this.array=[],this.object={},this.value=null,this.length=0,null!==t&&void 0!==t){if(Array.isArray(t))this.array=t;else if("object"==typeof t)for(var r in t)this.array.push(r);else this.array.push(t),this.value=t;this.length=this.array.length;for(var e=0;e<this.length;e++)this.object[this.array[e]]=!0}this.contains=function(t){if(0===this.length||0===t.length)return!1;if(1===this.length&&null!==this.value)return 1===t.length?this.value===t.value:t.object.hasOwnProperty(this.value);if(t.length<this.length)return t.contains(this);for(var r in this.object)if(t.object[r])return!0;return!1}}Array.isArray||(Array.isArray=function(t){return"[object Array]"==Object.prototype.toString.call(t)});

function PxLoaderImage(n,t,e){var i=this,o=null;this.img=new Image,this.tags=t,this.priority=e;var a=function(){"complete"==i.img.readyState&&(m(),o.onLoad(i))},r=function(){m(),o.onLoad(i)},d=function(){m(),o.onError(i)},m=function(){i.unbind("load",r),i.unbind("readystatechange",a),i.unbind("error",d)};this.start=function(t){o=t,i.bind("load",r),i.bind("readystatechange",a),i.bind("error",d),i.img.src=n},this.checkStatus=function(){i.img.complete&&(m(),o.onLoad(i))},this.onTimeout=function(){m(),i.img.complete?o.onLoad(i):o.onTimeout(i)},this.getName=function(){return n},this.bind=function(n,t){i.img.addEventListener?i.img.addEventListener(n,t,!1):i.img.attachEvent&&i.img.attachEvent("on"+n,t)},this.unbind=function(n,t){i.img.removeEventListener?i.img.removeEventListener(n,t,!1):i.img.detachEvent&&i.img.detachEvent("on"+n,t)}}PxLoader.prototype.addImage=function(n,t,e){var i=new PxLoaderImage(n,t,e);return this.add(i),i.img};
function Responsive(s){var t=640;if("0px"!=s.css("width"))var i=parseInt(s.css("width")),d=t/i;if("0px"!=s.css("height"))var p=parseInt(s.css("height")),r=t/p;var o=parseInt(s.css("font-size")),a=t/o;if("0px"!=s.css("line-height"))var n=parseInt(s.css("line-height")),e=t/n;if("0px"!=s.css("top"))var h=parseInt(s.css("top")),w=t/h;if("0px"!=s.css("left"))var c=parseInt(s.css("left")),x=t/c;if("0px"!=s.css("margin")){var g=0,f=0,b=0,m=0;if(s.hide(),"0px"!=s.css("margin-top"))var v=t/parseInt(s.css("margin-top"));if("0px"!=s.css("margin-right"))var I=t/parseInt(s.css("margin-right"));if("0px"!=s.css("margin-bottom"))var W=t/parseInt(s.css("margin-bottom"));if("0px"!=s.css("margin-left"))var l=t/parseInt(s.css("margin-left"));s.show()}if("0px"!=s.css("padding")){var u="0px",N="0px",z="0px",R="0px";if(s.hide(),"0px"!=s.css("padding-top"))var j=t/parseInt(s.css("padding-top"));if("0px"!=s.css("padding-right"))var k=t/parseInt(s.css("padding-right"));if("0px"!=s.css("padding-bottom"))var q=t/parseInt(s.css("padding-bottom"));if("0px"!=s.css("padding-left"))var y=t/parseInt(s.css("padding-left"));s.show()}if("0px"!=s.css("border-width")){var A="0px",B="0px",C="0px",D="0px";if("0px"!=s.css("border-top-width"))var E=t/parseInt(s.css("border-top-width"));if("0px"!=s.css("border-right-width"))var F=t/parseInt(s.css("border-right-width"));if("0px"!=s.css("border-bottom-width"))var G=t/parseInt(s.css("border-bottom-width"));if("0px"!=s.css("border-left-width"))var H=t/parseInt(s.css("border-left-width"))}if("absolute"!=s.css("position")){if(!isNaN(parseInt(s.css("top"))))var w=t/parseInt(s.css("top"));if(!isNaN(parseInt(s.css("right")))){t/parseInt(s.css("right"))}if(!isNaN(parseInt(s.css("bottom")))){t/parseInt(s.css("bottom"))}if(!isNaN(parseInt(s.css("left"))))var x=t/parseInt(s.css("left"))}$(window).resize(function(i){if(windowWidth=$(window).width(),windowWidth>t&&(windowWidth=t),"0px"!=s.css("width")){var p=windowWidth/d+"px";s.css({width:p})}if("0px"!=s.css("height")){var o=windowWidth/r+"px";s.css({height:o})}"0px"!=s.css("margin")&&(g="auto"==s.css("margin-top")?"auto":windowWidth/v+"px",f="auto"==s.css("margin-right")?"auto":windowWidth/I+"px",m="auto"==s.css("margin-bottom")?"auto":windowWidth/W+"px",b="auto"==s.css("margin-left")?"auto":windowWidth/l+"px",s.css({"margin-top":g,"margin-right":f,"margin-bottom":m,"margin-left":b})),"0px"!=s.css("padding")&&(u="auto"==s.css("padding-top")?"auto":windowWidth/j+"px",N="auto"==s.css("padding-right")?"auto":windowWidth/k+"px",R="auto"==s.css("padding-bottom")?"auto":windowWidth/q+"px",z="auto"==s.css("padding-left")?"auto":windowWidth/y+"px",s.css({"padding-top":u,"padding-right":N,"padding-bottom":R,"padding-left":z})),"0px"!=s.css("border-width")&&("0px"!=s.css("border-top-width")&&(A=windowWidth/E<=1?"1px":windowWidth/E+"px"),"0px"!=s.css("border-right-width")&&(B=windowWidth/F<=1?"1px":windowWidth/F+"px"),"0px"!=s.css("border-bottom-width")&&(D=windowWidth/G<=1?"1px":windowWidth/G+"px"),"0px"!=s.css("border-left-width")&&(C=windowWidth/H<=1?"1px":windowWidth/H+"px"),s.css({"border-top-width":A,"border-right-width":B,"border-bottom-width":D,"border-left-width":C}));var n=windowWidth/a+"px";if(s.css({"font-size":n}),"0px"!=s.css("line-height")){var h=windowWidth/e+"px";s.css({"line-height":h})}if("0px"!=s.css("top")){var c=windowWidth/w+"px";s.css({top:c})}if("0px"!=s.css("left")){var J=windowWidth/x+"px";s.css({left:J})}})}
;
